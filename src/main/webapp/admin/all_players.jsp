...
<form action="/receive" method="get">
    Id: <input type="text" name="updateId"/><br/>
...
%>
    <tr>
        ...
        <td><img src="<%= baseUrl%><%= player.getAvatarUrl() %>" alt="avatar<%=player.getId()%>" style="width: 10%"/>
        </td>
        ...
        <td>
            <form action="/receive" method="post" enctype="multipart/form-data">
                ...
                <input type="file" name="avatar"/><input type="submit" value="Upload"/>
            </form>
        </td>
    </tr>
    <%
